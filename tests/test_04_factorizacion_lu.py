...
assert(lb4.calculaLU(None) == (None, None, 0))

assert(lb4.calculaLU(np.array([[1,2,3],[4,5,6]])) == (None, None, 0))
...
b = np.array([1,1,1])
assert(np.allclose(lb4.res_tri(A,b),np.array([1,0,0])))

b = np.array([0,1,0])
assert(np.allclose(lb4.res_tri(A,b),np.array([0,1,-1])))

b = np.array([-1,1,-1])
assert(np.allclose(lb4.res_tri(A,b),np.array([-1,2,-2])))

b = np.array([-1,1,-1])
assert(np.allclose(lb4.res_tri(A,b,inferior=False),np.array([-1,1,-1])))

A = np.array([[3,2,1],[0,2,1],[0,0,1]])
b = np.array([3,2,1])
assert(np.allclose(lb4.res_tri(A,b,inferior=False),np.array([1/3,1/2,1])))
